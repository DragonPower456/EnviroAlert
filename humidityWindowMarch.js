...
function makeChart (data) {
  ...
  var svg = d3.select('#humiditychart').append('svg')
    .attr('width',  svgWidth)
...
d3.json('https://api.thingspeak.com/channels/------/feeds.json?api_key=----------------&start=2017-03-01%2001:01:01&end=2017-03-31%2001:01:01', function (error, rawData) {
